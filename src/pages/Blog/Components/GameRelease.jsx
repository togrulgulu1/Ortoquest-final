...
import "../assets/css/gameRelease.css"
    ...
    return (
        <section id='gameRelease'>
            <div className="con flex">
                ...
                <div className="gameReleaseMain">

                    <div className="gameReleaseLeft">

                    </div>

                    <div className="gameReleaseRight">
                        <span>7/31/20</span>
                        <span>Preview</span>
                        <h4>How Sand Road Saved Fall Releases</h4>
